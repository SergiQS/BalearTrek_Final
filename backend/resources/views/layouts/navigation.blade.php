        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('backoffice.users.create')" :active="request()->routeIs('backoffice.users.create')">
                        {{ __('Nuevo Usuario') }}
                    </x-nav-link>

                    <x-nav-link :href="route('backoffice.municipalities.index')" :active="request()->routeIs('backoffice.municipalities.index')">
                        {{ __('Municipios') }}
                    </x-nav-link>

                    <x-nav-link :href="route('backoffice.municipalities.create')"
                        :active="request()->routeIs('backoffice.municipalities.create')">
                        {{ __('Nuevo Municipio') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('backoffice.meetings.create')"
                      ...
                      <x-nav-link :href="route('backoffice.interestingplaces.index')" :active="request()->routeIs('backoffice.interestingplaces.index')">
                        {{ __('Sitios de interés') }}
                    </x-nav-link>

                    <x-nav-link :href="route('backoffice.interestingplaces.create')"
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-nav-link :href="route('backoffice.users.index')"
                        :active="request()->routeIs('backoffice.users.index')">
                        BackOffice
                    </x-nav-link>
